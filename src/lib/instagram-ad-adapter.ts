...
export class InstagramAdAdapter implements AdAdapter {
  ...
  async authenticate(account: SocialMediaAccount): Promise<SocialMediaAccount> {
    try {
      // Instagram reklamları Facebook Marketing API üzerinden yönetilir
      ...
      console.error('Instagram reklam kimlik doğrulama hatası:', error);
      return {
        ...account,
        status: 'expired'
      };
  ...
  async refreshToken(account: SocialMediaAccount): Promise<SocialMediaAccount> {
    ...
    try {
      ...
      console.error('Instagram reklam token yenileme hatası:', error);
      return {
        ...account,
        status: 'expired'
      };
  ...
  async createCampaign(account: SocialMediaAccount, campaignData: any): Promise<any> {
    try {
      ...
      const data = {
        ...
        promoted_object: {
          application_id: campaignData.instagram_account_id
        }
      };
      ...
      console.error('Instagram kampanya oluşturma hatası:', error);
      throw error;
    }
  }
  ...
  async updateCampaign(account: SocialMediaAccount, campaignId: string, campaignData: any): Promise<any> {
    try {
      ...
      console.error('Instagram kampanya güncelleme hatası:', error);
      throw error;
    }
  }
  ...
  async pauseCampaign(account: SocialMediaAccount, campaignId: string): Promise<any> {
    try {
      ...
      console.error('Instagram kampanya duraklatma hatası:', error);
      throw error;
    }
  }
  ...
  async resumeCampaign(account: SocialMediaAccount, campaignId: string): Promise<any> {
    try {
      ...
      console.error('Instagram kampanya devam ettirme hatası:', error);
      throw error;
    }
  }
  ...
  async deleteCampaign(account: SocialMediaAccount, campaignId: string): Promise<boolean> {
    try {
      ...
      console.error('Instagram kampanya silme hatası:', error);
      return false;
    }
  }
  ...
  async createAd(account: SocialMediaAccount, campaignId: string, adData: any): Promise<any> {
    try {
      ...
      console.error('Instagram reklam oluşturma hatası:', error);
      throw error;
    }
  }
  ...
  async updateAd(account: SocialMediaAccount, adId: string, adData: any): Promise<any> {
    try {
      ...
      console.error('Instagram reklam güncelleme hatası:', error);
      throw error;
    }
  }
  ...
  async pauseAd(account: SocialMediaAccount, adId: string): Promise<any> {
    try {
      ...
      console.error('Instagram reklam duraklatma hatası:', error);
      throw error;
    }
  }
  ...
  async resumeAd(account: SocialMediaAccount, adId: string): Promise<any> {
    try {
      ...
      console.error('Instagram reklam devam ettirme hatası:', error);
      throw error;
    }
  }
  ...
  async deleteAd(account: SocialMediaAccount, adId: string): Promise<boolean> {
    try {
      ...
      console.error('Instagram reklam silme hatası:', error);
      return false;
    }
  }
  ...
  async getAnalytics(account: SocialMediaAccount, entityId?: string, entityType?: string): Promise<any> {
    try {
      ...
      console.error('Instagram reklam analitik alma hatası:', error);
      throw error;
    }
  }
}
