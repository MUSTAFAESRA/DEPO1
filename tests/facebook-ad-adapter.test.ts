...
import { FacebookAdAdapter } from '../src/lib/facebook-ad-adapter';
...
describe('FacebookAdAdapter', () => {
  let facebookAdAdapter: FacebookAdAdapter;
  ...
  beforeEach(() => {
    ...
    facebookAdAdapter = new FacebookAdAdapter();
  ...
  describe('authenticate', () => {
    it('should return active status when authentication is successful', async () => {
      ...
      const result = await facebookAdAdapter.authenticate(mockAccount);
  ...
  describe('createCampaign', () => {
    it('should create campaign successfully', async () => {
      ...
      const result = await facebookAdAdapter.createCampaign(mockAccount, campaignData);
  ...
  describe('createAd', () => {
    it('should create ad successfully', async () => {
      ...
      const result = await facebookAdAdapter.createAd(mockAccount, campaignId, adData);
